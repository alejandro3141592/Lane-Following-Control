...
#Reads a video, on each frame performs a lane detection, and send a steering message via a ROS topic
...
steering_publisher = rospy.Publisher('AMR_Steering', Int8, queue_size=10)
