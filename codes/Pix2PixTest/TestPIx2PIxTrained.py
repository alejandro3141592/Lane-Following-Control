# Test a trained model of pix2pix with a video file.
...
checkpoint.restore("/home/alejandro/catkin_ws/src/lane_following/src/training_checkpoints/AvenidaTec/ckpt-6")
...
def generate_and_display_from_video(generator_model, video_capture):
    while True:
...
# Generate and display images from the video
generate_and_display_from_video(generator, cap)
